...
const notificationSchema = new mongoose.Schema(
  {
    ...
    audience: { type: String, enum: ['Admin', 'Teacher', 'Student', 'Parent', 'Principal', 'SuperAdmin', 'Specific', 'All'], default: 'All' },
    classId: { type: mongoose.Schema.Types.ObjectId, ref: 'Class' },
    sectionId: { type: mongoose.Schema.Types.ObjectId, ref: 'Section' },
    submissionId: { type: mongoose.Schema.Types.ObjectId, default: null, index: true },
    createdBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Admin' },
    createdByType: { type: String, enum: ['admin', 'super_admin', 'teacher', 'parent', 'student'], default: 'admin' },
    createdByTeacherId: { type: mongoose.Schema.Types.ObjectId, ref: 'TeacherUser', default: null },
    createdByParentId: { type: mongoose.Schema.Types.ObjectId, ref: 'ParentUser', default: null },
